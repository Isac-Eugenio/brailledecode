...
#define OK 12               // Botão para confirmação 
#define res 11              // Botão para resetar os botões da célula
 

KeyboardBraille key(5,6,7,8,9,10); // Definindo a pinagem dos botões
